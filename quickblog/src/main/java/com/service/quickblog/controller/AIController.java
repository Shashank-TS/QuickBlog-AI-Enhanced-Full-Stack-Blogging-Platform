...
public class AIController {
    ...
    public ResponseEntity<?> summarizeBlog(@RequestBody SummarizeBlogRequest request){
        return ResponseEntity.ok(aiService.SummarizeBlog(request));
    }
    @PostMapping("/generateblog")
    public ResponseEntity<?> generateBlog(@RequestBody generateBlogRequest request){

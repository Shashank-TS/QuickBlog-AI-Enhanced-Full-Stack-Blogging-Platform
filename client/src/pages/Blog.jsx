...
const Blog = () => {
  ...
  const addComment = async (e) => {
    ...
    try {
      ...
      if(userId){
      fetchCommentsData(); // Re-fetch comments to update the list
      }
  ...
  return (
    <div className="relative">
      ...
      <Navbar />
      {loadingBlogs ? (
          <Loader loading={loadingBlogs} spinnerSize="md" spinnerColor="text-purple-500" message="Loading your blog..." />
        ) : error ? (
      ...
      <div className="mx-5 max-w-5xl md:mx-auto my-10 mt-6">
        <img alt="" className="rounded-3xl mb-5" src={data.image} />
        <div
